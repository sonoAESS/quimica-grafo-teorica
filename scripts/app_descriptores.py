...
st.set_page_config(
    page_title="Visualizador de Descriptores",
    page_icon="🔬",
    layout="wide",
...
# Asegurarse de que el archivo .mol temporal se borre al finalizar la sesión si es necesario
# (Streamlit lo hará automáticamente al salir, pero es bueno ser explícito si se desea controlarlo)
# En este caso, no lo borramos aquí para que funcione en los tabs
...
# Opcional: Borrar archivo temporal al finalizar si es necesario
# (No es necesario aquí, ya que Streamlit lo maneja automáticamente)